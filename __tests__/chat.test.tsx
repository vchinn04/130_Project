...
describe("Chat Component", () => {
  ...
  it("sends a message when send button is clicked", async () => {
    ...
    // (Timestamp.fromMillis as jest.Mock).mockReturnValue(Date.now());
    (serverTimestamp as jest.Mock).mockReturnValue(null);

    (collection as jest.Mock).mockReturnValue(expect.anything());
    ...
    const sendButton = screen.getByTestId("send"); //, { name: /send/i });
  ...
  it("deletes a message when delete button is clicked", async () => {
    ...
    (doc as jest.Mock).mockResolvedValue(expect.anything());
